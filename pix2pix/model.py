rfrom __future__ import division
import os
import time
...
class pix2pix(object):
    ...
    def blind(self, args):
        ...
        init_op = tf.global_variables_initializer()
        self.sess.run(init_op)
        files = os.listdir('F:/pywork/BareFootResearch-master/pix2pixtest/datasets/footmask/blind')
        for x in files:
            sample_files = glob('./datasets/{}/blind/{}/*.jpg'.format(self.dataset_name,x))
        ...
        #add record image name and resize input image
            ...
            #image resize to normal size
                    ...
                    scipy.misc.imsave('./{}/{}/{}.jpg'.format(args.blind_dir,str(x) ,n[i]),samples_bw)
            #     save_images(samples_final, [self.batch_size, 1],
            #                 './{}/{}/{}.jpg'.format(args.blind_dir,str(x), n[i]))
